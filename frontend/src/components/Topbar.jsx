        ...
        {resultsOpen && (
          <div className="ent-notif-panel" style={{ top: '110%' }}>
            <div className="ent-notif-header">
              <span>{t('topbar.employees')}</span>
              {searching && <span className="ent-notif-count">{t('topbar.searching')}</span>}
            </div>
            <div className="ent-notif-list">
              {!searching && results.length === 0 && (
                <div className="ent-notif-empty">{t('topbar.noMatchesFound')}</div>
              )}
              {results.map((emp) => (
                <button
                  key={emp.id}
          ...
          {notifOpen && (
            <div className="ent-notif-panel">
              <div className="ent-notif-header">
                ...
                {unreadCount > 0 && (
                  <span className="ent-notif-count">{t('topbar.newCount', { count: unreadCount })}</span>
                )}
              </div>

              <div className="ent-notif-list">
                {notifications.length === 0 && (
                  <div className="ent-notif-empty">{t('topbar.noNotifications')}</div>
                )}
